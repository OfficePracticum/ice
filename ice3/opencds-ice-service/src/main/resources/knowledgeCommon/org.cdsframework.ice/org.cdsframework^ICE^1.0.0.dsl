...
[consequence][][Ii]nclude the [Rr]eason for [Ss]hot {refer_oTargetDose} [Ii]nvalid due to "Monovalent not Authorized"={refer_oTargetDose}.addInvalidReason("EVALUATION_REASON_CONCEPT.MONOVALENT_NOT_AUTHORIZED"); {refer_oTargetDose}.setRuleName(drools.getRule().getName());
